...
Tento model byl implementován také v jazyce MATLAB. Zápis implementace je velmi podobný popsanému pseudokódu výše. Nicméně ani jazyk MATLAB neobsahuje vestavěnou funkci pro řešení \todo{odlisnosti pro jednotlive nastroje}
