...
Platforma                                                                                           & Vše              & Vše        & Vše    & Windows, Linux   & Vše\footnote{Často nestabilní na MacOS} & Vše       & Vše            \\ \hline
...
Opensource\footnote{Volně dostupné zdrojové kódy, například na serveru github.com} & Ne               & ?          & Ano    & Ne               & Ano                                                & Ne        & Ano            \\ \hline
\end{tabular}%
}
...
Tento model byl implementován také v jazyce MATLAB. Pro účely výpočtu zde byla použita základní funkce pro řešení diferenciálních rovnic času pomocí voláním funkce \texttt{clock} na začátku a na konci běhu skriptu. Výsledkem rozdílu hodnot je pak čas strávený výpočtem. \todo{odlisnosti pro jednotlive nastroje}
