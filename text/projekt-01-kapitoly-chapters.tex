...
Před během simulace a po vyhodnocení výsledků je vhodné provést analýzu vhodnosti modelu pro simulaci. Pokud shledáme model nevalidním, není vhodný pro náš záměr.

\chapter{Popis simulačních nástrojů}
\label{kapitola3}
...
%   \item{Pokud je nějaká teorie hodně těžká (například HMM a spol.), nepopisujte jí celou, ale dejte úplně základy, citujte vhodný zdroj a \uv{vypíchněte} jen to, co je ve Vaší práci opravdu důležité.}
% \end{itemize}
...
% Citujeme-li tutéž publikaci vícekrát bezprostředně za sebou, můžeme místo opakování celé citace použít výrazu \uv{tamtéž}, doplněného číslem stránky.
...
% \noindent3. SRBECKÁ, Gabriela. Rozvoj kompetencí studentů ve vzdělávání. \it Inflow: information journal \rm [online]. 2010, roč. 3, č. 7 [cit. 2010-08-06]. ISSN 1802-9736. Dostupné z: \url{http://www.inflow.cz/rozvoj-kompetenci-studentu-ve-vzdelavani}
...
% Při citaci elektronických zdrojů vždy uveďte, kdy byla informace převzata, protože za~několik dní už může být celý web nedostupný. Při použití nástroje BibTeX toho můžete docílit přidáním klíče \verb|note = "[Online; navštíveno dd.mm.yyyy]"|. Citace elektronického zdroje bude mít většinou typ \verb|@misc|.
...
% %Accessible also from WWW: \\
% %\url{ftp://ftp.vision.ee.ethz.ch/publications/articles/eth\_biwi\_00517.pdf}
% \bigskip
% \rm
...
% \bf Nedělitelné mezery: \rm Udělat takovou typografickou hrubku jako ponechání \uv{s} na~konci řádku hned v názvu BP či DP je ostuda. Existuje něco, čemu se říká nedělitelná mezera, tedy mezera, ve které se nemůže zalomit konec řádku. V \LaTeX{}u se tato mezera označuje vlnkou \textasciitilde. Též pěkně popsáno v knize {\LaTeX} pro začátečníky \cite{Rybicka}.
