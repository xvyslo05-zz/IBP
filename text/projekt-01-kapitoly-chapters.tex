...
Grafické prostředí                                                                                  & Ano                                                                                                             & Ano        & Ano    & Ano     & Ano              & Ano                                                      & Ano\footnote{Jen s~příslušným rozšířením, viz \ref{jmodelica}}       & Ne             \\ \hline
...
Pro implementaci posloužil jako inspirace kód pro nástroj MATLAB převzatý z~oficiální dokumentace MathWorks\footnote{\url{https://www.mathworks.com/help/stateflow/ug/modeling-a-bouncing-ball-in-continuous-time.html}}. 
...
V této kapitole se nachází konečné srovnání volně dostupných simulačních nástrojů podle vytvořené metodiky, která je popsána v kapitole \ref{metodika}. \todo{doplnit}.
...
\todo{prepsat}Jazyk Python, konkrétně tedy rozšíření SciPy, byl do porovnání zařazen pouze z~kuriozity, jak si bude stát proti jazykům MATLAB a Modelica. Nicméně se ukázal jako velmi silný nástroj pro modelování a simulaci menších systémů. 
